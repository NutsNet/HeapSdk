#
#  Be sure to run `pod spec lint HeapSdk.podspec' to ensure this is a
...
This CocoaPods library will collect some events for the backend.
  ...
  # Or just: spec.author    = "Christophe Vichery"
  # spec.authors            = { "Christophe Vichery" => "vichery.christophe@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Christophe Vichery"
